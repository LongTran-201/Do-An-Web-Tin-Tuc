				...
				<div class="carousel-inner" role="listbox">
					...
					<c:forEach var="newsmodelcarousel" items="${carousel.listResult}">
						...
						<div class="carousel-item ${active}">
							<img class="d-block img-fluid" src="${newsmodelcarousel.thumbnail}" style="width:900px ;
				...
				<c:forEach var="newsmodel" items="${newsmodel.listResult}" >
					...
					<div class="card h-100">
						...
						<div class="card-body">
							...
							<h4 class="card-title">
								<a class="line-clamp" href="${detailURL}">${newsmodel.title}</a>
							</h4>
							<p class="new-detail-${newsmodel.id}">
								<a href="${detailURL}" style="text-decoration: none; color: inherit" class="line-clamp line2">
