						...
						<form id="formSubmit">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <input type="button"  class="btn btn-white btn-danger btn-bold" value="Huỷ"
...
<script>
    ...
    $('#btnAddOrUpdateNew').click(function (e) {
        ...
        var formData = $('#formSubmit').serializeArray();//get array data from formSubmit
    ...
    function goBackToHomePage() {
        window.location.href = "${pageContext.request.contextPath}/admin-news?type=list&page=1&maxPageItem=5&sortName=title&sortBy=asc";
    }
</script>
</body>
</html>
